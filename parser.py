...
def download_excel_schedule(Faculty, Group, Year, Number_of_group, Season, time):
    ...
    url = f"{base_url}2023-2024%20Raspisanie%20zanyatijj%20FPMM%20{Group}%20-{Year}-{Number_of_group}%20%28{Season}%20%20{time}%20smeny%29.xlsx"
